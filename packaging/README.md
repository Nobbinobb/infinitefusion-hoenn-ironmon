...
Version 0.8.1 includes the cumulative Ironmon mechanics, shared tracker sprite
presentation, support for manually installed and game-downloaded sprite data,
and an optional resumable custom-sprite-library download. Run-aware Pokémon
obtainability, the compact generated-evolution graph, seeded-run sharing,
battle-item control, aggregate type coverage, and signed, optionally expiring
diagnostic access remain available.
