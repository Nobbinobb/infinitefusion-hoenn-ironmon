...
public sealed class CustomSpriteInstallPlan
{
    ...
    /// <param name="includeUnavailable">Whether this review explicitly retries previously unavailable sheets.</param>
    internal CustomSpriteInstallPlan(string gameRoot, IReadOnlyList<CustomSpriteSheetTarget> pendingSheets, int totalSheetCount, int existingSheetCount, int unavailableSheetCount = 0, bool includeUnavailable = false)
    {
        GameRoot = gameRoot;
    ...
    /// <summary>
    /// Gets whether protected execution must also retry previously unavailable sheets.
    /// </summary>
    internal bool IncludeUnavailable { get; }
...
/// </summary>
/// <remarks>
/// Initializes one immutable synchronization target.
/// </remarks>
...
{
    /// <summary>
    /// Fusion sheets partitioned by head and sheet variant.
    /// </summary>
    Fusion = 0,

    /// <summary>
    /// Normal-species sheets containing every alternate sprite cell.
    /// </summary>
    Base = 1
}
