...
public partial class EvolutionGraph : IAsyncDisposable
{
    ...
    private const double _canvasPadding = 40;
    ...
    private const double _levelBandGap = 24;
    private const double _levelBandPadding = 39;
    private const double _nodeGap = 15;
    private const double _nodeHeight = 56;
    private const double _nodeWidth = 142;
    private const double _rangeButtonGap = 8;
    private const double _rangeButtonHeight = 24;
    private const double _rangeButtonWidth = 124;
    private const double _rangeSelectorGap = 16;
    private const double _rowGap = 96;
