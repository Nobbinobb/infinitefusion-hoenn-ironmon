...
This document records the implemented protocol through the 0.8.8 tracker UI,
...
An active 0.8.8 run also includes optional aggregate type-coverage context:
