...
This document records the implemented protocol through the 0.8.4 tracker UI,
...
An active 0.8.4 run also includes optional aggregate type-coverage context:
