...
schema-version-1 state. A new run and F7 both create a fresh state after the new
seed is assigned, while the separate configuration snapshot preserves all
