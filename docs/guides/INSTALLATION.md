# Installing Ironmon 0.6.5

Ironmon `0.6.5` targets Pokemon Infinite Fusion 2 version 6.8.0.
...
3. Extract `Ironmon-v0.6.5-challenge-lifecycle.zip` into the game's root directory—the
