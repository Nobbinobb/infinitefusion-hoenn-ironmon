# Installing Ironmon 0.6.4

Ironmon `0.6.4` targets Pokemon Infinite Fusion 2 version 6.8.0.
...
3. Extract `Ironmon-v0.6.4-randomization.zip` into the game's root directory—the
