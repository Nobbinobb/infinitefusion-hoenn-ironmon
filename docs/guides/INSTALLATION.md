# Installing Ironmon 0.7.1

Ironmon `0.7.1` targets Pokemon Infinite Fusion 2 version 6.8.0.
...
3. Extract `Ironmon-v0.7.1-randomization-fixes.zip` into the game's root directory—the
