...
- The target's generated base-stat total must be within the higher-strength
  range defined in `EVOLUTION_RANDOMIZATION.md`.
...
of autogenerated fusion sprites. `EVOLUTION_RANDOMIZATION.md` defines the
detailed strength ranges, stage constraints, branch conflict behavior, special
evolution methods, and terminal-species handling.
...
4. Step 3.4 implements the rules in `EVOLUTION_RANDOMIZATION.md`, including
   deterministic complete-fusion evolution targets.
