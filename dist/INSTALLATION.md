# Installing Ironmon 0.7.0

Ironmon `0.7.0` targets Pokemon Infinite Fusion 2 version 6.8.0.
...
3. Extract `Ironmon-v0.7.0-starter-selection.zip` into the game's root directory—the
