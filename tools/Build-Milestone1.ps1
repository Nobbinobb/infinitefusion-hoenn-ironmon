...
$archive = Join-Path $releaseDirectory "Ironmon-Milestone-1-v1.0.0.zip"
$checksum = Join-Path $releaseDirectory "Ironmon-Milestone-1-v1.0.0.sha256.txt"
...
Set-Content -LiteralPath $checksum -Value "$hash  Ironmon-Milestone-1-v1.0.0.zip"
