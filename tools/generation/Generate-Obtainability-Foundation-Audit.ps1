...
Write-Output "Obtainability foundation audit generated: $($summary.encounter_slots) encounter slots, $($summary.randomizable_item_slots) randomizable item slots, $($summary.required_evolution_items) required evolution items, and $($summary.event_acquisition_calls + $summary.source_acquisition_calls) acquisition call sites."
